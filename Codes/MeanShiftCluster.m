...
% Bart Finkston. Mean Shift Clustering (https://www.mathworks.com/matlabcentral/fileexchange/10161-mean-shift-clustering), MATLAB Central File Exchange.
% initial
[numDim,numPts] = size(dataPts);
numClust        = 0;
bandSq          = bandWidth^2;
initPtInds      = 1:numPts;
stopThresh      = 1e-3*bandWidth;                                           % determine mean has converged
